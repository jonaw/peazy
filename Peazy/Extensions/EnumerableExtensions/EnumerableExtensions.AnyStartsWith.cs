...
namespace Peazy.Extensions
{
    ...
    {
        /// <summary>
        /// Check if any item in an enumerable start with value. Compares values with <see cref="StringComparison.Ordinal" />
        /// </summary>
        /// <param name="source">Source to seek for value</param>
        /// <param name="value">Value to seek for</param>
        /// <returns>Returns true if <paramref name="value"/> is found at start of any value in <paramref name="source"/>, else returns false</returns>
        public static bool AnyStartsWith(this IEnumerable<string> source, string value)
            => EnumerableHelpers.AnyStartsWith(source, value, StringComparison.Ordinal, StringNullStrategy.Skip);

        /// <summary>
        /// Check if any item in an enumerable start with value
        /// </summary>
        /// <param name="source">Source to seek for value</param>
        /// <param name="value">Value to seek for</param>
        ...
        /// <returns>Returns true if <paramref name="value"/> is found at start of value in <paramref name="source"/>, given by <paramref name="selector"/>, else returns false</returns>
        public static bool AnyStartsWith<T>(this IEnumerable<T> source, Func<T, string> selector, string value)
                => EnumerableHelpers.AnyStartsWith(source, selector, value, StringComparison.Ordinal, StringNullStrategy.Skip);
